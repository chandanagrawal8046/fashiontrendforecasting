            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="contactForm" method="post" action="regcompany" autocomplete="off">
                            <div class="row">
                                <div class="col-md-10">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="url" class="form-control" placeholder="Company Url : http://www.mycompany.com" id="compurl" name="compurl" required data-error="Please Enter Company URL"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="form-group">                                       
                                        <textarea class="form-control" id="address" name="address" placeholder="Address" required data-error="Please enter address"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="headoffice" name="headoffice" placeholder="Your headoffice city" required data-error="Please enter your headoffice city">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-10">
